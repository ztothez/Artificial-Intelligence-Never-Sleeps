...
TIMELINE: list[Segment] = [
    ...
    Segment("raw", "scene10_threshold_awareness", 4.500, "zoom_in_slow"),
    ...
    Segment("raw", "scene11c_blackout_01_city_lights_on", 2.500, "static_full_frame"),
    Segment("raw", "scene11d_blackout_02_total_power_failure", 2.000, "static_full_frame"),
    Segment("black", "bridge_tagline_void", 3.000),
